                ...
                <div className="story-card py-2 px-4 mx-auto w-[50rem]">
                    <div className='bg-white w-full rounded-xl px-5 py-3 flex flex-col gap-3'>
                        ...
                        <div className='flex items-center justify-between'>
                            ...
                            <button className='px-3 py-2 bg-[#F45044] text-white flex items-center gap-1 rounded'><GoPlus size={22} /> Create Party</button>
                        ...
                        <div className="flex items-center gap-3 px-1 my-5">
                            <button
                                ...
                                className={`font-medium hover:text-[#F45044]  ${activeTab === 'all-party'
                            ...
                            <button
                                ...
                                className={`font-medium hover:text-[#F45044]  ${activeTab === 'my-party'
                                    ? 'border-b-[1px] border-[#F45044] text-[#F45044] font-semibold '
                                    : 'font-medium'
                                    }`}
                            >
                            ...
                            <button
                                ...
                                className={`font-medium hover:text-[#F45044]  ${activeTab === 'booked-party'
                                    ? 'border-b-[1px] border-[#F45044] text-[#F45044] font-semibold '
                                    : 'font-medium'
                                    }`}
                            >
                            ...
                            {groupDetails.map((g) => {
                                return <div key={g.id} className='border rounded-lg h-fit'>
                                    ...
                                    <div className='px-5 flex flex-col gap-5'>
                                        ...
                                        <Link href={`/party/${g.id}`} className='w-full bg-[#F45044] text-white py-2 mb-4 rounded-md flex items-center justify-center'>View details</Link>
                                    </div>
                                </div>
                            })}
